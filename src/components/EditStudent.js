...
function EditStudent() {
    ...
    useEffect(() => {
        Axios.get("https://crud-deplyoment-backend1.onrender.com/studentRoute/update-student/" + id)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://crud-deplyoment-backend1.onrender.com/studentRoute/update-student/" + id, data)
            .then((res) => {
                if (res.status === 200)
